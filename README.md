# Домашняя работа №1 по занятию Python advanced Урок 1.
...
# How to use
6 заданий. Для каждого свой hw_01_01.py (первый индекс - номер домашнего задания, второй индекс - номер задания)
